...
LinkedListallocate_node(int data) {
...
LinkedList append_node(LinkedListlist, int new_data) {
...
LinkedList reverse_node(LinkedListlist) {
    LinkedList prev = NULL;
    LinkedListcurrent = list;
